...
namespace Samples
{
    ...
    public class EWrapperImpl : EWrapper
    {
        ...
        //! [socket_init]
        public EWrapperImpl(SynchronizationContext sc)
        {
        ...
        public virtual void tickPrice(int tickerId, int field, double price, TickAttrib attribs)
        {
            ...
            if (tmp != null)
                sc.Post((t) => tmp(new TickPriceMessage(tickerId, field, price, attribs)), this);
        ...
        public virtual void historicalData(int reqId, Bar bar)
        {
            ...
            //Console.WriteLine(bar.Time + ";" + bar.Open + ";" + bar.High + ";" + bar.Low + ";" + bar.Close);
            //sw.WriteLine(bar.Time + ";" + bar.Open + ";" + bar.High + ";" + bar.Low + ";" + bar.Close);

            var tmp = HistoricalData;

            if (tmp != null)
                sc.Send((t) => tmp(new HistoricalDataMessage(reqId, bar)), null);
        }
        //! [historicaldata]
        ...
        public virtual void realtimeBar(int reqId, long time, double open, double high, double low, double close, long volume, double WAP, int count)
        {
            ...
            if (tmp != null)
                sc.Send((t) => tmp(new RealTimeBarMessage(reqId, time, open, high, low, close, volume, WAP, count)), null);
        }
        //! [realtimebar]
